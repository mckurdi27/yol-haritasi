...
function renderLanguageButtons(
  ...
  /*
    LANGS dizisinin sırası aynen
    ekranda kullanılacaktır.
...
function renderQuestion() {
  ...
  /*
    Seçilen dil önce gösterilir.

    Ardından diğer 10 dil,
    LANGS dizisindeki sabit sıraya göre
    gösterilir.
  */
