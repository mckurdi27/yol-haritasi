...
Her günün JSON dosyası günün başlığını, alt başlığını ve sorularını içerir.

{
  "day": 2,
  "dayTitle": {
    "tr": "2. Gün — Vahiy, Kur'an ve İslâm'ın Temel Kaynakları"
  },
  "daySubtitle": {
    "tr": "Vahiy, Cebrâil, ilk vahiy, Kur'an'ın yapısı ve sünneti tanımak"
  },
  "questions": [
    {
      "id": 20,
...
Bu yapı sayesinde yeni bir gün eklemek için yalnızca ilgili "day-XX.json" dosyasını oluşturmak yeterlidir. "app.js" dosyası mevcut günleri otomatik olarak bulur.
